      ...
      <TermsAndConditionsStyles>
        ...
        <div className="section">
          ...
          <p>
            ...
            from using the site and you must discontinue immediately.
          </p>
          ...
          <p>
            ...
            changes or modifications to these Terms of Use are posted.
          </p>
        ...
        <div className="section">
          ...
          <p>
            By using the Site, you represent and warren that (1) you have the
        ...
        <div className="section">
          ...
          <p>
            ...
            free that we can use and share such feedback for any purpose without
            compensation to you.
          </p>
        ...
        <div className="section">
          ...
          <p>
            ...
            Marketplace Offerings ("Submissions") provided by you to us are non
        ...
        <div className="section">
          ...
          <p>
            ...
            Use, we receive the right to, in our sole discretion and without
            ...
            limitation for breach of representation, warranty, or covenant
        ...
        <div className="section">
          ...
          <p>
            ...
            of the State of Wisconsin applicable to agreements made and to be
            entirely performed within the State of Wisconsin, without regard to
        ...
        <div className="section">
          ...
          <p className="bold">Informal Negotiations</p>
          ...
          <p>
            ...
            those Disputes expressly provided below) informally for at least 30
            days before initiating arbitration. Such informal negotiations
            commence upon written notice from one Party to the other Party.
          </p>

          <p className="bold">Binding Arbitration</p>
          ...
          <p>
            ...
            and, where appropriate, the A.Afo:s Supplementary Procedures for
            ...
            arbitration will take place in Waupaca County, Wisconsin . Except as
          ...
          <p>
            ...
            state and federal courts located in Waupaca County, Wisconsin, and
        ...
        <div className="section">
          ...
          <p>
            ...
            US. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED
