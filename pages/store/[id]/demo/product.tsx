...
export const getServerSideProps: GetServerSideProps = async context => {
  try {
    ...
    return {
      // TODO: send the user to an error page instead of sending props to the component
      props: { error: 'Server error while fetching the product' },
    };
  }
};
...
export default function DemoProduct(props: Props) {
...
const DemoProductStyles = styled.div`
